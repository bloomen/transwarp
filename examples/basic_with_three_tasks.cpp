...
void basic_with_three_tasks(std::ostream& os) {
    ...
    auto task1 = transwarp::make_task(transwarp::consumer, "something", compute_something);
    auto task2 = transwarp::make_task(transwarp::consumer, "something else", compute_something_else);

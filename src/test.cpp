...
TEST_CASE("circular_buffer_buffer_of_size_one_no_elements") {
    const std::size_t size = 1;
    tw::detail::circular_buffer<double> buffer(size);
    REQUIRE(size == buffer.size());
    REQUIRE(0 == buffer.populated());
    REQUIRE(buffer.empty());
}

TEST_CASE("circular_buffer_buffer_of_size_one_with_one_added") {
    const std::size_t size = 1;
    tw::detail::circular_buffer<double> buffer(size);
    REQUIRE(size == buffer.size());
...
TEST_CASE("circular_buffer_buffer_of_size_one_with_two_added") {
    const std::size_t size = 1;
    tw::detail::circular_buffer<double> buffer(size);
    REQUIRE(size == buffer.size());
...
TEST_CASE("circular_buffer_buffer_of_size_two_with_two_added") {
...
TEST_CASE("circular_buffer_buffer_of_size_two_with_three_added") {
    const std::size_t size = 2;
    tw::detail::circular_buffer<double> buffer(size);
    REQUIRE(size == buffer.size());
    const double value1 = 42;
...
TEST_CASE("circular_buffer_buffer_of_size_one_pop") {
...
TEST_CASE("circular_buffer_buffer_of_size_two_pop") {
...
TEST_CASE("circular_buffer_buffer_of_size_three_with_push_overload") {
...
TEST_CASE("circular_buffer_buffer_of_size_three_push_and_pop") {
    tw::detail::circular_buffer<double> buffer(3);
    const double value1 = 42;
    const double value2 = 46;
    const double value3 = 14;

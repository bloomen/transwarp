...
TEST_CASE("schedule_with_three_tasks_wait") {
    ...
    REQUIRE(tw::task_type::root == task1->node()->type());
    REQUIRE(tw::task_type::root == task2->node()->type());
    REQUIRE(tw::task_type::wait == task3->node()->type());
...
TEST_CASE("schedule_with_three_tasks_wait_any") {
    ...
    REQUIRE(tw::task_type::root == task1->node()->type());
    REQUIRE(tw::task_type::root == task2->node()->type());
    REQUIRE(tw::task_type::wait_any == task3->node()->type());
...
TEST_CASE("schedule_with_three_tasks_consume_any") {
    ...
    REQUIRE(tw::task_type::root == task1->node()->type());
    REQUIRE(tw::task_type::root == task2->node()->type());
    REQUIRE(tw::task_type::consume_any == task3->node()->type());
